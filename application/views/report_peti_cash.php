		  ...
		  <div class="row">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-12">
					...
					<br />
					<input autocomplete="off" name="sort" id="datesort" class="form-control" style="float:left;width:180px;margin-right:5px;" placeholder="Sort Date" />&nbsp;
...
<!--
						<a href="<?php echo site_url('report_peti_cash/cleanup'); ?>" class="btn btn-default"><i class="fa fa-trash-o"></i> Clear</a>
-->
					<?php if ($from && $to) : ?>
