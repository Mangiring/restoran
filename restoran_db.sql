...
--
-- Inang: 127.0.0.1
-- Waktu pembuatan: 23 Okt 2015 pada 06.35
-- Versi Server: 5.5.32
-- Versi PHP: 5.4.16
...
(1, 1, 1, 'root@restoran.com', 'e89591ee9b8e7018511649a2146ae279', '*1445574233', 1),
...
INSERT INTO `wishlist_tab` (`wid`, `wname`, `wtid`, `wtotal`, `wdisc`, `wtotalall`, `wdate`, `wstatus`) VALUES
(41, 'sandi', 4, 29500, 0, 29500, '2015-10-23 00:00:00', 1);
